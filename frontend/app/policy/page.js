      ...
      <div style={{ lineHeight: '1.8', fontSize: '1.05rem', color: '#31333F' }}>
        ...
        <section style={{ marginBottom: '2rem' }}>
          ...
          <ul style={{ paddingLeft: '1.5rem', marginTop: '0.5rem', marginBottom: '0.5rem' }}>
            ...
            <li>국세청 등 공공 통계 데이터 기반 100대 생활밀접업종 창업·폐업 트렌드 리포트</li>
            <li>기타 소상공인 창업·폐업 관련 정보 제공</li>
          </ul>
          <p>본 사이트의 정보와 시뮬레이션 결과는 참고용이며 법적 효력이 없습니다. 최종적인 행정 절차, 자격 여부, 지원 금액 및 실거래가, 공식 통계 수치 확인은 반드시 공식 발행 기관 및 관련 전문가의 안내가 기준이 됩니다.</p>
        </section>

        <section style={{ marginBottom: '2rem' }}>
          <h3 style={{ fontSize: '1.25rem', fontWeight: '700', marginBottom: '0.5rem' }}>제3조 (서비스의 이용)</h3>
          <ul style={{ paddingLeft: '1.5rem' }}>
            <li>본 서비스는 별도의 회원가입 절차 없이 누구나 무료로 이용할 수 있습니다.</li>
            <li>본 사이트는 서비스의 내용, 제공 방식, 운영 시간 등을 운영상·기술상의 필요에 따라 변경할 수 있으며, 변경 시 사전 또는 사후에 공지합니다.</li>
            <li>본 사이트는 설비의 보수·점검, 공공 API 연동 장애, 천재지변, 통신 장애 등 불가항력적 사유가 있는 경우 서비스 제공을 일시 중단할 수 있습니다.</li>
          </ul>
        </section>
        ...
        <section style={{ marginBottom: '2rem' }}>
          ...
          <ul style={{ paddingLeft: '1.5rem' }}>
            <li>본 사이트가 제공하는 창업·폐업 트렌드 리포트, 상권 분석 데이터, 상가 실거래가, 폐업 비용 계산 결과 등은 공공데이터를 기반으로 가공한 참고용 자료이며, 실제 지표나 공식 기관의 발표 수치와 차이가 발생할 수 있습니다. 최종 판단 및 의사결정은 반드시 원천 데이터 및 관련 기관의 안내를 기준으로 하시기 바랍니다.</li>
            <li>비용 계산기 및 시뮬레이션 기능은 보조 도구이며, 실제 소요되는 비용이나 성공 여부를 보장하지 않습니다.</li>
            <li>제공되는 데이터, 통계 수치, 금액 등은 출처 기관의 사정에 따라 사전 고지 없이 변경될 수 있으며, 이로 인한 직접적·간접적 손해에 대하여 본 사이트는 어떠한 법적 책임도 지지 않습니다.</li>
            <li>본 사이트는 세무·노무·법률·부동산 중개 상담을 대체하지 않습니다. 개별 사안의 구체적인 실행은 반드시 해당 분야 전문가(세무사, 공인중개사 등)의 상담을 받으시기 바랍니다.</li>
            <li>본 사이트에 게재된 외부 링크를 통해 접속한 제3자 사이트의 내용 및 정책에 대해서는 본 사이트가 책임지지 않습니다.</li>
          </ul>
        </section>
        ...
        <section style={{ marginBottom: '2rem' }}>
          ...
          <p>국가통계포털(KOSIS), 공공데이터포털 API 원문 및 원천 통계 데이터의 저작권은 해당 발행 기관에 있으며, 본 사이트는 이를 공익적 정보 제공 및 분석 목적으로 재구성해 안내합니다.<br/>
        ...
        <section style={{ marginBottom: '2rem' }}>
          ...
          <ul style={{ paddingLeft: '1.5rem' }}>
            ...
            <li>서비스 이용과 관련하여 본 사이트와 이용자 간에 분쟁이 발생한 경우, 당사자 간 협의로 해결함을 원칙으로 하며, 협의가 이루어지지 않을 때에는 민사소송법상의 관할 법원에 제소할 수 있습니다.</li>
          </ul>
        </section>
        ...
        <section style={{ marginBottom: '4rem' }}>
          ...
          <p>본 약관은 2026년 06월 29일부터 시행됩니다.</p>
        </section>
        ...
        <section style={{ marginBottom: '2rem' }}>
          ...
          <ul style={{ paddingLeft: '1.5rem', marginTop: '0.5rem' }}>
            ...
            <li>식별자: 쿠키 및 유사 기술에 의해 생성된 식별자</li>
          </ul>
        </section>
        ...
        <section style={{ marginBottom: '2rem' }}>
          ...
          <ul style={{ paddingLeft: '1.5rem' }}>
            ...
            <li>이용자의 관심사에 맞는 맞춤형 트렌드 콘텐츠 추천 및 광고 노출</li>
            <li>관련 법령상 의무 이행</li>
          </ul>
        </section>
        ...
        <section style={{ marginBottom: '2rem' }}>
          ...
          <p>본 개인정보처리방침은 법령·정책 또는 서비스 내용(신규 데이터 API 연동 등) 변경에 따라 개정될 수 있으며, 변경 시 본 페이지를 통해 공지합니다. 중요한 변경 사항이 있을 경우 시행일 최소 7일 전부터 공지합니다.</p>
        </section>
      </div>
