...
def render_policy_card(p):
    ...
    trget_text = format_bullets(p['trget_nm'])
    summary_text = format_bullets(p['bsns_sumry_cn'])
    reqst_text = format_bullets(p['reqst_mth_papers_cn'])
