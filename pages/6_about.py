...
st.set_page_config(page_title="RebornBiz 소개 | RebornBiz", page_icon="📢", layout="wide", initial_sidebar_state="auto")
...
set_custom_sidebar()
inject_seo_tags()
log_page_access("사이트 소개")

st.title("📢 RebornBiz 소개")
...
**피드백 및 문의**
잘못된 정보, 깨진 링크 신고 또는 서비스 기능 개선 제안은 운영팀(help.rebornbiz@gmail.com)으로 알려주시면 빠르게 검토하여 반영하겠습니다.
""")
